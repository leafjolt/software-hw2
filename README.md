...
After running the [script.sql](./script.sql) file on your own machine, my code requires a `.env` file to be set up with your database info for security reasons.
